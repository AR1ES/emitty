...
describe('Parser/Dependencies', () => {
    it('Jade', () => {
        ...
        const config = new config_1.Config('jade');
        const dependencies = dependencies_1.parseDependencies(content, config.getConfig());
    ...
    it('Nunjucks', () => {
        ...
        const config = new config_1.Config('nunjucks');
        const dependencies = dependencies_1.parseDependencies(content, config.getConfig());
        assert.deepEqual(dependencies, [
            'layouts/default.njk',
            'test-0.njk',
    ...
    it('SugarML', () => {
        ...
        const config = new config_1.Config('sugarml');
        const dependencies = dependencies_1.parseDependencies(content, config.getConfig());
        assert.deepEqual(dependencies, [
            'layouts/default.sgr',
            'test-0.sgr',
    ...
    it('PostHTML', () => {
        ...
        const config = new config_1.Config('posthtml');
        const dependencies = dependencies_1.parseDependencies(content, config.getConfig());
        assert.deepEqual(dependencies, [
    ...
    it('Less', () => {
        ...
        const config = new config_1.Config('less');
        const dependencies = dependencies_1.parseDependencies(content, config.getConfig());
        assert.deepEqual(dependencies, [
            'test-0.less',
            'test-1.less',
    ...
    it('Stylus', () => {
        ...
        const config = new config_1.Config('stylus');
        const dependencies = dependencies_1.parseDependencies(content, config.getConfig());
        assert.deepEqual(dependencies, [
            'test-0.styl',
            'test-1.styl',
    ...
    it('Sass', () => {
        ...
        const config = new config_1.Config('sass');
        const dependencies = dependencies_1.parseDependencies(content, config.getConfig());
        assert.deepEqual(dependencies, [
            'test-0.sass',
            'test-1.sass',
    ...
    it('SCSS', () => {
        ...
        const config = new config_1.Config('scss');
        const dependencies = dependencies_1.parseDependencies(content, config.getConfig());
        assert.deepEqual(dependencies, [
            'test-0.scss',
            'test-1.scss',
